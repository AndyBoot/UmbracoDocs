...
namespace My.Website.ContentFinders
{
    public class My404ContentFinder : IContentLastChanceFinder
    {
        ...
        public bool TryFindContent(PublishedRequest contentRequest)
        {
            ...
            var domain = allDomains?.Where(f => f.DomainName == contentRequest.Uri.Authority || f.DomainName == "https://" + contentRequest.Uri.Authority || contentRequest.Uri.AbsolutePath.ToLower().StartsWith(f.DomainName.ToLower())).FirstOrDefault();
